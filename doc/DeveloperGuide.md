...
5. Should not require an installer to function.
6. Should be easily modifiable by students of CS2103.
7. Should store data in a user-editable format.
8. Should prioritise text input over graphical input.
